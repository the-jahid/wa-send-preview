                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-slate-500">
                            ...
                            <li><Link href="/#use-cases" className="hover:text-slate-900 dark:hover:text-white transition-colors">Use Cases</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-slate-500">
                            <li><Link href="/free-tools/number-checker" className="hover:text-slate-900 dark:hover:text-white transition-colors relative inline-flex items-center gap-2">
