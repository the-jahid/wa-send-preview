                ...
                >
                    {NAV_ITEMS.map((item, idx) => (
                        <Link
                            ...
                            className={`relative z-10 px-3 py-1.5 text-sm font-medium rounded-full transition-colors duration-200 ${activeIdx === idx
                    ...
                    >
                        <button
                            className={`relative z-10 flex items-center gap-1 px-3 py-1.5 text-sm font-medium rounded-full transition-colors duration-200 ${activeIdx === NAV_ITEMS.length
                                ? "text-slate-900 dark:text-white"
                                : "text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"
                                }`}
                        >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                transform: activeIdx === NAV_ITEMS.length ? "translateY(0)" : "translateY(8px)",
                    ...
                    <SignedOut>
                        ...
                        <SignUpButton mode="modal" forceRedirectUrl="/dashboard">
                            <button className="group px-4 py-2 text-sm font-semibold rounded-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:from-emerald-400 hover:to-emerald-500 transition-all shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 flex items-center gap-1.5 whitespace-nowrap">
                                <span className={isScrolled ? "hidden sm:inline" : ""}>Start Free</span>
